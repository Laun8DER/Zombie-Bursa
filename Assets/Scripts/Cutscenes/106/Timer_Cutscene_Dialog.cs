...
public class Timer_Cutscene_Dialog : MonoBehaviour
{
    public PlayableDirector cutseneDialogDirector;
    ...
    public void setCutsceneDialogOff()
    {
        this.enabled = false;
    }
}
