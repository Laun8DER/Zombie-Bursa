...
public class Cutscene_ZombieChase : MonoBehaviour
{
    [Header("Escape Dialog")]
    public Timer_Cutscene_Dialog escapeDialog;
    ...
    public Cutscene_Zombie_Health health;
    ...
    private void Awake()
    {
        ...
        if (health == null)
        {
            health = GetComponent<Cutscene_Zombie_Health>();
        }
    }
    ...
    public void setEscapeDialogOn()
    {
        escapeDialog.enabled = true;
    }
}
