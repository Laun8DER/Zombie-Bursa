...
public class IlyaManager : MonoBehaviour
{
    [Header("Character")]
    public SpriteRenderer ilyaspriteRenderer;
    public Sprite ilyaWithoutClothes;
    ...
    private void OnEnable()
    {
        ...
        inputManager.actions.Player.Interact.performed += TakeClothesOff;
    }
    public void TakeClothesOff(InputAction.CallbackContext context)
    {
        if (canInteract)
        {
            ilyaspriteRenderer.sprite = ilyaWithoutClothes;
        }
    }
    private void Update()
    {
