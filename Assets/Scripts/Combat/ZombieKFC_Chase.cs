...
public class ZombieKFC_Chase : MonoBehaviour
{
    [Header("References")]
    ...
    public ZombieKFC_Health health;
    ...
    private const string IdleStateName = "ZombieKFC_Idle";
    private const string WalkStateName = "ZombieKFC_Walk";
    private const string BiteStateName = "ZombieKFC_Bite";
    ...
    private void Awake()
    {
        ...
        if (health == null)
        {
            health = GetComponent<ZombieKFC_Health>();
        }
    }
